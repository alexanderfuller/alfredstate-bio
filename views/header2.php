...
<ul id="dropdown1" class="dropdown-content" style = "height:100px; margin-top:143px;">
  <li><a href="../controller/alex2.php">About Me (Databinded Version)</a></li>
...
<ul id="dropdown3" class="dropdown-content" style = "height:100px; margin-top:143px;">
  <li><a href="../controller/careers2.php">Web Development Career Paths</a></li>
    <li><a href="../controller/managecareers.php">Manage Web Development Career Paths</a></li>
	 <li><a href="../views/future2.php">Future Employment</a></li>
</ul>
    ...
    <ul class="right hide-on-med-and-down" style = "width:100%; float:left; background:#000099; ">
	 ...
	 <li><a  href="../views/user.php"> <i class="tiny material-icons left">home</i>Home </a></li>
      <li><a  class="dropdown-button" href="#!" data-activates="dropdown1"><i class="tiny material-icons left">face</i>About Me<i class="material-icons right">arrow_drop_down</i></a></li>
       <li><a  href="../controller/courses2.php"> <i class="tiny material-icons left">import_contacts</i>My Courses</a></li>
	  <li><a  class="dropdown-button" href="#!" data-activates="dropdown3"><i class="tiny material-icons left">work</i>Web Development<i class="material-icons right">arrow_drop_down</i></a></li>
	   <li><a  class="dropdown-button" href="#!" data-activates="dropdown4"><i class="tiny material-icons left">perm_identity</i><?=$_SESSION['sess_user'];?><i class="material-icons right">arrow_drop_down</i></a></li>
    </ul>
	<ul class="side-nav" id="mobile-demo">
        <li><a href="../views/user.php">Home</a></li>
        <li><a href="../controller/alex2.php">About Me</a></li>
        <li><a href="../controller/courses2.php">My Courses</a></li>
        <li><a href="../controller/careers2.php">Web Dev</a></li>
